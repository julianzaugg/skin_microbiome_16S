...
# Assign colours for taxa
# taxa_colours_immunocompromised.l <- setNames(c("grey", my_colour_pallete_12_soft), unique(genus_data_processed_immunocompromised_summary.df$taxonomy_genus))
# taxa_colours_immunocompetent.l <- setNames(c("grey", my_colour_pallete_12_soft), unique(genus_data_processed_immunocompetent_summary.df$taxonomy_genus)) 
taxa_colours.l <- setNames(c("grey", my_colour_pallete_12_soft),unique(c(as.character(genus_data_processed_immunocompromised_summary.df$taxa_label), as.character(genus_data_processed_immunocompetent_summary.df$taxa_label))))
