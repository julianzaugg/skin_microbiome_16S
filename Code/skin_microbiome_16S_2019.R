...
# Samples with OTU counts lower than our desired threshold need to be removed if we want to rarefy!
# This should have been performed at this point!
...
# Rarefaction curve
# rarecurve(t(otu.m[,colSums(otu.m) > 1]),step = 500, label = F,xlim = c(0,20000),sample = 20000)
...
# Uncomment this to use the rarefied otu matrix for 
# relative abundance calculations etc. later
...
#colSums(project_otu_table[samples_lost])
...
# FIXME - currently just un-rarfied abundances
